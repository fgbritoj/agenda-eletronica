...
class Controller{
	...
	public static function getMessage(){
		...
		$msg = (isset($_SESSION[Controller::MSG]) && $_SESSION[Controller::MSG] != array()) ? $_SESSION[Controller::MSG] : null;
	...
	public static function redirect(ResponseInterface $response, string $route)
	{
